...
class CheckApplicationIntegrationStrategy extends EventManager\AbstractListenerAggregate implements ServiceManager\ServiceLocatorAwareInterface
{
    ...
    public function attach (EventManager\EventManagerInterface $pEventManager)
    {
        ...
        $this->listeners[] = $pEventManager->attach(Service::EVENT_CHECK_APPLICATION_INTEGRATION, $options, 1);
    }
