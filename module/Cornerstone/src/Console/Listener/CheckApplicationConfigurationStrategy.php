...
class CheckApplicationConfigurationStrategy extends EventManager\AbstractListenerAggregate implements ServiceManager\ServiceLocatorAwareInterface
{
    ...
    public function attach (EventManager\EventManagerInterface $pEventManager)
    {
        ...
        $this->listeners[] = $pEventManager->attach(Service::EVENT_CHECK_APPLICATION_CONFIGURATION, $options, 1);
    }
